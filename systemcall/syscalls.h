...
asmlinkage long sys_plus(int x,int y,int *to_user);
asmlinkage long sys_minus(int x,int y,int *to_user);
asmlinkage long sys_multi(int x,int y,int *to_user);
asmlinkage long sys_rest(int x,int y,int *to_user);
